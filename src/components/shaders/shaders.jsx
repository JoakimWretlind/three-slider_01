...
export const fragmentShader = `
  ...
  void main() {
    ...
    // The vec2 timer -> will make the whole transition work without strange lines or delays
    // The vec4 Coords -> will set the rotation of the outgoing image
    ...
    // The vec2 timer -> will make the whole transition work without strange lines or delays
    // The vec4 Coords -> will set the rotation of the incoming image
